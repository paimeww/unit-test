...
import DropdownFilterWorklistCPRO from "../components/DropdownFilterWorklistCPRO";
import DropdownSelectColumnWorklistCPRO from "../components/DropdownSelectColumnWorklistCPRO";
...
const UtilityWorklistCPRO = ({ sessionData, userRoles }) => {
      ...
      <Row className="mt-2">
        ...
        >
          ...
          <div className="row d-sm-none d-flex">
            <div className="">
              <DropdownFilterWorklistCPRO />
            </div>
            <div className="">
              <DropdownSelectColumnWorklistCPRO />
            </div>
          </div>
        </Col>
        <Col xl="6" md="6" sm="6">
...
export default React.memo(UtilityWorklistCPRO);
