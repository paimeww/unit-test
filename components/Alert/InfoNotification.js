...
const InfoNotification = ({ onConfirm, onClose, title, description }) => {
  return (
    <React.Fragment>
      <div
        style={{ top: -100 }}
      ...
      >
        ...
        <div className="w-100 d-flex justify-content-start py-1 px-2 bg-info rounded">
        ...
        <div className="row p-1 d-flex justify-content-end">
          <div
            ...
            onClick={onConfirm}
            className="bg-info px-2 rounded text-white d-flex justify-content-center align-items-center mr-2 c-button"
          >
            OK
          </div>
        </div>
