...
export const getAllRoles = () => async (dispatch) => {
  try {
    ...
    const response = await axios({
      url: `${API_MASTER_DATA}/api/master/Role`,
      method: "get",
      headers: header,
    });
...
export const getAllModules = () => async (dispatch) => {
  try {
    ...
    const response = await axios({
      url: `${API_MASTER_DATA}/api/master/Module`,
      method: "get",
      headers: header,
    });
...
export const getAllSubmodules = () => async (dispatch) => {
  try {
    ...
    const response = await axios({
      url: `${API_MASTER_DATA}/api/master/Submodule`,
      method: "get",
      headers: header,
    });
...
export const getAllForms = () => async (dispatch) => {
  try {
    ...
    const response = await axios({
      url: `${API_MASTER_DATA}/api/master/Form`,
      method: "get",
      headers: header,
    });
...
export const getAllAkses = () => async (dispatch) => {
  try {
    ...
    const response = await axios({
      url: `${API_MASTER_DATA}/api/master/Action`,
      method: "get",
      headers: header,
    });
...
export const getAllMaterialType = () => async (dispatch) => {
  try {
    const response = await axios({
...
export const getAllCurrency = () => async (dispatch) => {
  try {
    ...
    const response = await axios({
      url: `${API_MASTER_DATA}/api/Currency`,
      method: "get",
      headers: getHeaders(store.getState().auth.token),
    });
...
export const getAllUser = (searchQuery) => async (dispatch) => {
  try {
    const header = getHeaders(store.getState().auth.token);

    const response = await axios({
      url: `${API_MASTER_DATA}/api/master/User`,
      method: "get",
      headers: {
        ...header,
        "X-PAGINATION": true,
